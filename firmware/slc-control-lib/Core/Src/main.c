...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DC_Pin|DRV1_Pin|DRV2_Pin|REPH_Pin
                          |REPL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : REPH_Pin REPL_Pin */
  GPIO_InitStruct.Pin = REPH_Pin|REPL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
