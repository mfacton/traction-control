...
void HAL_COMP_MspInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP4_MspInit 0 */
    ...
    PB0     ------> COMP4_INP
    */
    GPIO_InitStruct.Pin = TACHB0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(TACHB0_GPIO_Port, &GPIO_InitStruct);

    /* COMP4 interrupt Init */
    HAL_NVIC_SetPriority(COMP4_IRQn, 2, 0);
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP4_MspDeInit 0 */
    ...
    PB0     ------> COMP4_INP
    */
    HAL_GPIO_DeInit(TACHB0_GPIO_Port, TACHB0_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PA9     ------> I2C2_SCL
    */
    GPIO_InitStruct.Pin = SDAD_Pin|SCLD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PA9     ------> I2C2_SCL
    */
    HAL_GPIO_DeInit(SDAD_GPIO_Port, SDAD_Pin);

    HAL_GPIO_DeInit(SCLD_GPIO_Port, SCLD_Pin);
